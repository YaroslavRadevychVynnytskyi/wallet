...
@Component
public class HighLoanHandler implements LoanHandler {
    private static final BigDecimal REPAYMENT_TERM_IN_MONTHS = BigDecimal.valueOf(12);
    private static final BigDecimal INTEREST_RATE = BigDecimal.valueOf(1.1);
    private static final BigDecimal LOAN_BOUND = BigDecimal.valueOf(10_000);
